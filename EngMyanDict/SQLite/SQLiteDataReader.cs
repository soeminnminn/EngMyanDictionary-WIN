...
namespace Microsoft.Data.SQLite
{
    ...
    public class SQLiteDataReader : DbDataReader
    {
        ...
        private readonly Queue<KeyValuePair<sqlite3_stmt, bool>> _stmtQueue;
        ...
        internal SQLiteDataReader(
            ...
            Queue<KeyValuePair<sqlite3_stmt, bool>> stmtQueue,
            int recordsAffected,
            bool closeConnection)
        {
            if (stmtQueue.Count != 0)
            {
                var queue = stmtQueue.Dequeue();
                _stmt = queue.Key;
                _hasRows = queue.Value;
            }
        ...
        public override int FieldCount
        {
            get
            {
                ...
                return raw.sqlite3_column_count(_stmt);
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            {
                raw.sqlite3_reset(_stmtQueue.Dequeue().Key);
            }
        ...
        public override bool IsDBNull(int ordinal)
        {
            ...
            else if (!_stepped || _done)
            {
                throw new InvalidOperationException(Resources.NoData);
            }
            else
            {
                return GetSqliteType(ordinal) == raw.SQLITE_NULL;
            }
        }
        ...
        {
            return decimal.Parse(GetString(ordinal), NumberStyles.Number | NumberStyles.AllowExponent, CultureInfo.InvariantCulture);
        }
        ...
        public override double GetDouble(int ordinal)
        {
            ...
            {
                return raw.sqlite3_column_double(_stmt, ordinal);
            }
        }
        ...
        public override long GetInt64(int ordinal)
        {
            ...
            {
                return raw.sqlite3_column_int64(_stmt, ordinal);
            }
        }
        ...
        public override string GetString(int ordinal)
        {
            ...
            {
                return raw.sqlite3_column_text(_stmt, ordinal);
            }
        }
        ...
        {
            byte[] bytes = GetBlob(ordinal);
            if (bytes != null)
            {
                var len = Math.Min(bytes.Length - dataOffset, length);
                Array.Copy(bytes, dataOffset, buffer, bufferOffset, len);
                return len;
            }
            return -1;
        }
        ...
        public override long GetChars(int ordinal, long dataOffset, char[] buffer, int bufferOffset, int length)
        {
            ...
            if (bytes != null)
            {
                ...
                var len = Math.Min(chars.Length - dataOffset, length);
                Array.Copy(chars, dataOffset, buffer, bufferOffset, len);
                return len;
            }
            return -1;
        }
        ...
        private byte[] GetBlob(int ordinal)
        {
            ...
            {
                return raw.sqlite3_column_blob(_stmt, ordinal) ?? _emptyByteArray;
            }
        }
        ...
        {
            using (IDataReader reader = _command.ExecuteReader(CommandBehavior.KeyInfo | CommandBehavior.SchemaOnly))
            {
