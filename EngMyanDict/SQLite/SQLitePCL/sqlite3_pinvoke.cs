...
#define PRELOAD_FROM_ARCH_DIRECTORY
...
#endif
    public sealed class SQLite3Provider_PInvoke : ISQLite3Provider
    {
        ...
        public SQLite3Provider_PInvoke()
        {
#if NETFX_CORE
...
#pragma warning restore 649
        ...
        private static class NativeMethods
        {
...
#else
                    var currentAssembly = typeof(NativeMethods).GetType().Assembly;
#endif
            ...
            [DllImport(SQLITE_DLL, ExactSpelling = true, EntryPoint = "sqlite3_mprintf", CallingConvention = CallingConvention.Cdecl)]
